...
\section{2.Train-Test Split}\label{train-test-split}}
...
\end{tcolorbox}
    ...
    \hypertarget{xgboost}{%
\subsection{3.3. XGBoost}\label{xgboost}}
...
\section{4. Predictor comparison}\label{predictor-comparison}}
