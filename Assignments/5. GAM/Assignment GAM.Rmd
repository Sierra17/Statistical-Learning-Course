...
Now we test the null hypothesis that states one model is correct against the alternative that another model is better.
...
```{r}
anova(gam_1, gam_4, test="F")
```

```{r}
anova(gam_0, gam_3, gam_2, gam_4, gam_1, test="F")
```
